import { readFile, writeFile, chmod, unlink, access } from "node:fs/promises";
...
export default class GitProtect extends BaseCommand {
  static override description = "Install a pre-commit hook that blocks secrets from ever entering git history.";
