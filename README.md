...
| `--ai-generated` | Scan AI-generated code files specifically |
| `--ci` | CI mode — exit 1 if any critical or high findings |
| `--fix` | Interactive remediation mode for findings |
...
| `slickenv git protect` | Install pre-commit hook that blocks secret commits |
